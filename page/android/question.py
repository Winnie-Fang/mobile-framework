...
class QuestionPage(BaseObject):
    ...
    def overview_info_title(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.ID,'com.cathaybk.ihave.uat:id/info_title'),
            remark=f"{self.remark()} > 單位總覽_單位"
        )
    def overview_response_rate(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.ID,'com.cathaybk.ihave.uat:id/response_rate'),
            remark=f"{self.remark()} > 單位總覽_回覆率"
        )
    def overview_response_rate(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.ID,'com.cathaybk.ihave.uat:id/response_rate'),
    ...
    def unit_select_text(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.ID,'com.cathaybk.ihave.uat:id/unit_select_text'),
            remark=f"{self.remark()} > 轄下單位_選單文字"
        )
    def info_unit(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.ID,'com.cathaybk.ihave.uat:id/select_text'),
            remark=f"{self.remark()} > 進行中_單位文字"
        )
    def info_Name(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.ID,'com.cathaybk.ihave.uat:id/name_content'),
            remark=f"{self.remark()} > 進行中_姓名"
        )
    def info_response_rate(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.ID,'com.cathaybk.ihave.uat:id/response_rate'),
            remark=f"{self.remark()} > 進行中_回覆率"
        )
    def info_response_total(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.ID,'com.cathaybk.ihave.uat:id/response_total'),
            remark=f"{self.remark()} > 進行中_應回覆"
        )
    def info_received(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.ID,'com.cathaybk.ihave.uat:id/received'),
            remark=f"{self.remark()} > 進行中_已回覆"
        )
    def info_not_received(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.ID,'com.cathaybk.ihave.uat:id/not_received'),
            remark=f"{self.remark()} > 進行中_未回覆"
        )
    def info_phone(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.ID,'com.cathaybk.ihave.uat:id/phone_content'),
            remark=f"{self.remark()} > 進行中_手機"
        )
    def info_emergency_contact(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.ID,'com.cathaybk.ihave.uat:id/emergency_block'),
            remark=f"{self.remark()} > 進行中_緊急聯絡人"
        )
    '''回覆狀況查詢頁_end'''
    def back(self):
        return BasicComponent(
    ...
    def preview_title(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.ID, "com.cathaybk.ihave.uat:id/toolbar_title"),
            remark=f"{self.remark()} > 問卷預覽_title"
        )
    def preview_reviewlist(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.ID, "ccom.cathaybk.ihave.uat:id/reviewList"),
            remark=f"{self.remark()} > 問卷預覽_預覽項目"
        )
    def preview_list1(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.XPATH, '//androidx.recyclerview.widget.RecyclerView[@resource-id="com.cathaybk.ihave.uat:id/reviewList"]/android.view.ViewGroup[1]'),
            remark=f"{self.remark()} > 問卷預覽_list1"
        )
    def preview_unit(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.ID, 'com.cathaybk.ihave.uat:id/company_content'),
            remark=f"{self.remark()} > 問卷預覽_單位"
        )
    def preview_date(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.ID, 'com.cathaybk.ihave.uat:id/date_content'),
            remark=f"{self.remark()} > 問卷預覽_時間"
        )
    def preview_contact_title(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.ID, 'com.cathaybk.ihave.uat:id/contact_title'),
            remark=f"{self.remark()} > 問卷預覽_聯絡人"
        )
    def preview_verify_btn(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.ID, 'com.cathaybk.ihave.uat:id/btn_submit'),
            remark=f"{self.remark()} > 問卷預覽_審核btn"
        )
    def preview_contact_unit(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.ID, 'com.cathaybk.ihave.uat:id/title'),
            remark=f"{self.remark()} > 問卷預覽_聯絡人_部門"
        )
    def preview_contact_name(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.ID, 'com.cathaybk.ihave.uat:id/name_content'),
            remark=f"{self.remark()} > 問卷預覽_聯絡人_姓名"
        )
    def preview_contact_phone(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.ID, 'com.cathaybk.ihave.uat:id/phone_content'),
            remark=f"{self.remark()} > 問卷預覽_聯絡人_電話"
        )
    def unverify_content(self):
        return BasicComponent(
            lambda :self.driver.find_element(AppiumBy.XPATH,'//androidx.recyclerview.widget.RecyclerView[@resource-id="com.cathaybk.ihave.uat:id/reviewList"]/android.view.ViewGroup[1]/android.view.ViewGroup[@resource-id="com.cathaybk.ihave.uat:id/info"]/android.widget.TextView[@resource-id="com.cathaybk.ihave.uat:id/content"]'),
            remark=f"{self.remark()} > 未回審核_部門&發布日期"
        )
    def preview_answer_layout(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.XPATH, '//android.widget.ScrollView[@resource-id="com.cathaybk.ihave.uat:id/scrollView"]/android.widget.LinearLayout/android.widget.LinearLayout[2]'),
            remark=f"{self.remark()} > 問卷預覽_問卷回答框"
        )
    def preview_remind(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.ID, 'com.cathaybk.ihave.uat:id/remind'),
            remark=f"{self.remark()} > 問卷預覽_備註"
        )
    def preview_verify_rwd(self):
        return BasicComponent(
            lambda: self.driver.find_element(AppiumBy.ID, 'com.cathaybk.ihave.uat:id/toolbar_title'),
            remark=f"{self.remark()} > 問卷預覽_rwd_審核"
        )
    '''預覽頁_end'''