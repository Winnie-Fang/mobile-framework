...
def test_unlock_001():
    ...
    # old.pre_login().assert_visible()
    # 同意服務條款
    if navigator.gmb_login_page.service_title().is_visible() is True:
        navigator.gmb_login_page.scroll_down_btn().click()
        navigator.gmb_login_page.agree_btn().click()

    # old.login_slogan().assert_visible()
