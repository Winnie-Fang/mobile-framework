...
class DeviceManager:
    ...
    def android_driver(cls):
        ...
        # 根據是否為 debug 模式來設定不同的 newCommandTimeout
    ...
    def ios_simulator_driver(cls):
        ...
        options.set_capability('includeSafariInWebviews', True)
        options.set_capability('newCommandTimeout', 3000)  # 设置新命令的超时时间，单位是秒
        # options.set_capability('app', "/Users/twinb00551192/Desktop/ihave_uat/ihave_uat_noscreenshot.app")
...
if __name__ == '__main__':
    # DevicesManager.get_driver()
    # print(DeviceManager._create_driver())
